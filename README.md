...
核心升级：**草图故事板 + 表演节奏锁**。故事板默认改为导演草图/预演线稿，不再使用实景照片或电影剧照式画法，避免 Seedance 把故事板里的临时人物、场景纹理、服装和道具误当成资产参考；同时强化台词表演规则，Seedance 提示词必须在每句原文台词前写清人物当下情绪、心理、表情、呼吸、音量、语气和听者反应，并按正常中文语速拆分时长。长场戏按视听节奏拆成连续段落，可用上一段末帧或视频继续生成。完整模板详见 [提示词武器库索引](references/prompt-library-index.md)。
